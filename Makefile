# Makefile for installing/uninstalling the renumseq(1) man page.
#
# renumseq itself is installed via pip (see README.md); pip has no
...
# anything -- 'make install' just copies renumseq.1 into place, and
...
help:
	@echo "renumseq man-page installer (renumseq itself is installed via pip)"
	@echo ""
